      ...
      <div className="max-w-4xl mx-auto px-6 py-10 space-y-40 relative z-10">
        ...
        <section id="timeline" className="space-y-12 group scroll-mt-32">
          ...
          <div className="relative border-l border-slate-800 ml-4 space-y-12 pb-4">
             ...
             <TimelineItem title="The Antifragile Turn" date="2020-2022" color="indigo">
                Navigated extreme resource constraints while working rigorous manual labor (Tree Service) during the Vermont 2021/2022 winter. This era proved that ambition can survive even when resources are at zero. It culminated in <Highlight color="amber">Burlington Code Academy</Highlight>'s 3-month fulltime MERN bootcamp', where I graduated top-of-class in the <Highlight color="amber">final pre-ChatGPT cohort</Highlight>, re-igniting my entrance back into tech.
             </TimelineItem>
        ...
        <section id="domains" className="space-y-12 group scroll-mt-32">
          ...
          <div className="prose prose-invert prose-lg max-w-none text-gray-300 leading-relaxed">
            <p>My mind is an association engine. I can poke a stick in a campfire and see embers that remind me of particle trails in a cloud chamber. To me, a jazz mode is just a function, and a kitchen service is just a packet-switching network. I don't just "know" these domains, I understand the universal patterns that connect them.</p>
          </div>
